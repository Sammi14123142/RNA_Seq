...
# return the full file names of files in packages
...
```{r messages=FALSE}
library(Rsamtools)
bam.list <- BamFileList(bam.files) # yieldSize
...
# exons for the first gene
exons.by.gene[[1]]
# num of genes in the subset
length(exons.by.gene)
# num of exons for every gene
